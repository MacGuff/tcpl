...
void print_err(stack *errstk, int lineno)
{
    ...
    while (!pop(errstk, &errno, &pos))
    {
        ...
        case 1:
            ...
            break;
        case 2:
            printf("closing unopened square bracket, coloumn %d\n", pos + 1);
            break;
        case 3:
            printf("closing unopened curly braces, coloumn %d\n", pos + 1);
            break;
        case 4:
            printf("trying to close unopened block/control structure, colimn %d\n",
                   pos + 1);
            break;
        case 5:
